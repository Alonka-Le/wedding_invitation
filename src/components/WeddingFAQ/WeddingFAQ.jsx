...
const faqs = [
  {
    ...
    answer:
      "Спершу ми розділимо з вами особливу мить — урочисту церемонію розпису, яка відбудеться в Олександрівському РАЦСі за адресою: м. Запоріжжя, вул. Архівна, 2 о 10:00.         Після цього запрошуємо вас на  вінчання, яке пройде в церкві 'Віфлєєм' на вул. І.Виговського, 119 0 12:00. Ми будемо щасливі, якщо ви розділите з нами ці щирі й пам’ятні миті 💞",
  },
  {
